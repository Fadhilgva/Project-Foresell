...
@section('title', 'Category sales statistics')
...
@section('content')
   ...
   <div class="card mb-4">
    ...
    <a href="#coll1" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2022</h6>
    </a>
...
<div class="card mb-4">
    ...
    <a href="#coll2" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2021</h6>
    </a>
...
<div class="card mb-4">
    ...
    <a href="#coll3" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2020</h6>
    </a>
...
<div class="card mb-4">
    ...
    <a href="#coll4" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2019</h6>
    </a>
...
<div class="card mb-4">
    ...
    <a href="#coll5" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2018</h6>
    </a>
...
<div class="card mb-4">
    ...
    <a href="#coll6" class="d-block card-header py-3" data-toggle="collapse" role="button"
        ...
        <h6 class="m-0 font-weight-bold text-primary">{{ $categories->name }} Monthly Purchase Statistics in 2017</h6>
    </a>
