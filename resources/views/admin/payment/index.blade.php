            ...
            <div class="box-body">
                <div class="">
                    <table id="example1" class="table tbl-users table-responsive-sm table-hover table-bordered bg-white">
                        ...
                        <tbody>
                            @foreach ($payment->take(4) as $pay)
                            <tr>

                                <td>{{ $loop->iteration }}</td>
                                <td>
                                    <div style="width:87px">
                                        <a href="{{ route('payment.edit', $pay->id)}}" class="btn btn-warning btn btn-edit" id="edit"><i class="fas fa-pen"></i></a>

                                        {{-- <a href="/admin-foresell/list/payment/{{ $pay->id }}/confirm" class="btn btn-danger btnbtn-hapus" id="delete"><i class="fa fa-trash"></i></a> --}}
                                    </div>
                                </td>
                                <td>
...
{{-- MODAL DAFTAR --}}
<div class="modal fade" id="modal-daftar" tabindex="-1" role="dialog" aria-labelledby="modal-notification" aria-hidden="true">
    <div class="modal-dialog modal-default modal-dialog-centered " role="document">
        <div class="modal-content">
