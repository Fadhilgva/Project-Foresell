...
<div class="container-fluid">
	...
	<a href="/admin_toko/data_produk/create" class="btn btn-primary my-2">Add Product</a>
	...
	<table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <tr>
                ...
                <td><a type="button" class="btn btn-warning" href="/admin_toko/data_produk/edit">Ubah</a> <a type="button" class="btn btn-danger" href="#">Hapus</a></td>
            </tr>
            <tr>
                <td>2</td>
