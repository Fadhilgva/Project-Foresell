...
@section('content')
    <div class="container rounded shadow-sm my-1 border">
        @foreach ($stores as $store)
            <form action="/admin_toko/editprofile/{{ $store->id }}" method="POST" class="mt-3"
                enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-2 mt-4">
                        <div class="d-flex flex-column align-items-center text-center"><img class="rounded-circle my-0"
                                width="150px" src="\image\adminToko\logo\{{ $store->image }}">
                        </div>
                        <input
                    ...
                    <div class="col-md-5 mt-3">
                        <div class="row g-3">
                            ...
                            @error('location') is-invalid @enderror"
                                        id="location" name="location" placeholder="Enter your store Location"
                            ...
                            @error('description') is-invalid @enderror"
                                        id="description" name="description" placeholder="Enter your Store Description" rows="3">{{ old('description', $store->desc) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12 my-1 mt-5">
                                <div class="mb-3 subtitle">
                                    ...
                                    @if ($store->banner)
                                        <img src="\image\adminToko\logo\{{ $store->banner }}"
                                            class="img-preview img-fluid mb-4 shadow col-sm-12 d-block">
                                        <input
                                            class="form-control form-control-sm subtitle
