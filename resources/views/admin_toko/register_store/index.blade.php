                                ...
                                <div class="row g-3 mb-4 ">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="name" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Full Name" required value="{{ old('name') }}" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="name" name="storeName" class="form-control @error('storeName') is-invalid @enderror" id="storeName" placeholder="Store Name" required value="{{ old('storeName') }}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="name" name="city" class="form-control @error('city') is-invalid @enderror" id="city" placeholder="Store Name" required value="{{ old('city') }}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="name" name="postalcode" class="form-control @error('postalcode') is-invalid @enderror" id="postalcode" placeholder="Store Name" required value="{{ old('postalcode') }}" />
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            @error('phone') is-invalid @enderror" id="phone" placeholder="08XXXXXXXXXX" required value="{{ old('phone') }}" />
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            ...
                                            @error('password') is-invalid @enderror" id="password" placeholder="name@example.com" required value="" />
