                            ...
                            <div class="table-responsive mb-4">
                                @foreach ($carts as $cart => $items)
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <a class="reset-anchor d-block animsition-link"
                                                                ...
                                                                @if ($cart->product->image)
                                                                    <img src="img/admin_store/{{ $cart->product->image }}"
                                                                        width="70" />
                                                                @else
                                                                    <img src="{{ asset('img/customer/img-1.png') }}"
                                                                        width="70" />
                                                                @endif
                                                            </a>
                                                            <div class="ms-3">
                                                                <a class="reset-anchor animsition-link title text-decoration-none"
                                                                    href="/products/{{ $cart->product->slug }}">{{ $cart->product->name }}</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-5">
                                                                    ...
                                                                    <input type="number" name="quantity"
                                                                        value="{{ $cart->qty }}" class="w-100 ms-5"
                                                                        min="0" max="{{ $cart->product->stock }}">
                                                                </div>
                                                            </div>
                                                            <button type="submit" class="btn btn-sm btn-dark ms-5    mt-2"
                                                        ...
                                                        <form action="/delete_cart" method="post">
                                                            ...
                                                            <a class="reset-anchor">
                                                                <button type="submit" class="btn btn-link">
                                                                    <img src="{{ asset('img/customer/bx-trash.svg') }}"
                                                                        width="20">
                                                                </button>
                                                            </a>
                                                        </form>
                                    ...
                                    <div class="text-md-end">
                                        <a class="btn btn-dark" href="/shipping/{{ $cart->store_id }}"> checkout <i
                    ...
                    <div class="mt-3">
                        <div class="row align-items-center text-center">
                            <div class="col-md-6 mb-3 mb-md-0 text-md-start">
                                <a class="btn btn-outline-dark" href="/products"><i class='bx bx-shopping-bag'></i> Continue
                                    shopping</a>
                            </div>
                        </div>
                    </div>
