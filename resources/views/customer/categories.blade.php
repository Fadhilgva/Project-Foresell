        ...
        <div class="col-md-4 mb-2">
            <a href="/categories?category={{ $category->slug }}">
                <div class="card categories text-white border-0 m-3">
                    @if($category->image)
                    <img src="\image\admin\category/{{ $category->image }}" class="card-img" alt="" width="600" height="150">
                    @else
                    <img src="https://source.unsplash.com/1519x400?{{ $category->name }}" class="card-img" alt="" width="600" height="150">
                    @endif
